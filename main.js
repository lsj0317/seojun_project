...
// 사용 변수
const SETTING_TIME = 10; // 게임 타임 10초
let words = [];
let time;
let isPlaying = false;
let score = 0;
...
const url = "https://random-word-api.herokuapp.com/word?number=100"; // 랜덤한 단어 가져오기
...
function run() { // 게임 실행
    ...
    wordInput.value = "";
    wordInput.focus() // 커서 포커스가 되도록
    score = 0;
    scoreDisplay.innerText = 0; // 점수 텍스트를 0점으로 초기화시킬수있게
    time = SETTING_TIME;
    isPlaying = true;
